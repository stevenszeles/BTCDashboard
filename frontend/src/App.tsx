            ...
            <div className="modal-body">
              ...
              <div className="modal-section">
                ...
                <div className="modal-text">
                  ...
                  <span className="mono"> symbol/sym/ticker, qty/quantity, price/mark/last, avg_cost/avg_price, asset_class/type, underlying, expiry/exp, strike, option_type/right, sector, strategy, side</span>
                </div>
                <input
                  className="input"
                  type="file"
